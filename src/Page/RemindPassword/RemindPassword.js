...
import { useNavigate } from 'react-router-dom'; // Zmieniony import
import './RemindPassword.css'; // Użycie pliku CSS do stylów
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate('/login'); // Przejście do strony logowania po udanym resecie
      } else {
